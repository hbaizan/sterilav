...
(function () {
    ...
    ko.validation.rules['min'] = {
        ...
        message: 'Por favor ingrese un valor mayor o igual a {0}.'
    };
    ...
    ko.validation.rules['max'] = {
        ...
        message: 'Por favor ingrese un valor menor o igual a {0}.'
    };
    ...
    ko.validation.rules['minLength'] = {
        ...
        message: 'Por favor ingrese al menos {0} caracteres.'
    };
    ...
    ko.validation.rules['maxLength'] = {
        ...
        message: 'Por favor no ingrese mas de {0} caracteres.'
    };
    ...
    ko.validation.rules['pattern'] = {
        ...
        message: 'Por favor revise este valor.'
    };
    ...
    ko.validation.rules['step'] = {
        ...
        message: 'El valor debe incrementarse de a {0}'
    };
    ...
    ko.validation.rules['digit'] = {
        ...
        message: 'Por favor ingrese un dígito'
    };
    ...
    ko.validation.rules['phoneUS'] = {
        ...
        message: 'Por favor especifique un teléfono válido'
    };
    ...
    ko.validation.rules['equal'] = {
        ...
        message: 'Los valores deben ser iguales'
    };
    ...
    ko.validation.rules['notEqual'] = {
        ...
        message: 'Por favor elija otro valor.'
    };
    ...
    ko.validation.rules['unique'] = {
        ...
        message: 'Por favor asegúrese que el valor es unico.'
    };
